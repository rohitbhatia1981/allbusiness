	...
	<div class="container">
		...
		<div class="new_listings_row">
			<div class="new_listings_bx">
				<div class="left">
					<img alt="New listings" src="images/new_listings_01.jpg">
				</div>
				<div class="center">
					<ul class="breadcrumb">
						<li>Food/Hospitality</li> 
						<li>></li>
						<li><a href="#">Building and Construction for sale in Shepparton</a></li>
					</ul>
					<h4>Flooring Franchise in the Beautiful Sapphire Coast of NSW!</h4>
					<h6>Melbourne, VIC</h6>
					<div class="price_tag">$354,000</div>
					<h5>Takings: $24,000 <span>per week</span></h5>
					<h5>Net profit: $24,000 <span>per week</span></h5>
					<p>Picture running an artisan’s delight in a popular seaside tourist  destination where your delectable creativity will thrive while there is a non profit...</p>
				</div>
				<div class="right">
