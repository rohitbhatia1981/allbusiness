...
class EAC_API{
	...
	private $api_test_url = 'https://www.eac.net.au/api/';
	...
	function save_ln_in_db() {
    	...
    	if( empty($listings) &&
	        ...
	        echo json_encode(
	            array(
	                'status'    =>  'success',
	                'message'   =>  '<strong> Listing numbers fetched : <br> Please do not navigate from this page <br> Listing Details processing will follow</strong><br>',
	                'geocoded'  =>  '',
	                'buffer'    =>  'processing'
	            )
	        );
