	...
	*/
	...
	class ezSQL_mysqli extends ezSQLcore
	{
		...
		*/
		...
		function __construct($dbuser='', $dbpassword='', $dbname='', $dbhost='localhost', $encoding='utf8')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function quick_connect($dbuser='', $dbpassword='', $dbname='', $dbhost='localhost', $dbport='3306', $encoding='utf8')
		{
			$return_val = false;
