...
<html lang="en" dir="ltr">
	<head>
		...
		<!--Sidemenu css -->
        <link  href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/css/sidemenu.css" rel="stylesheet">

		<!--Texteditor css -->
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/wysiwyag/richtext.css" rel="stylesheet">
		...
		<!---Sidebar css-->
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/sidebar/sidebar.css" rel="stylesheet" />
		...
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/jvectormap/jqvmap.css" rel="stylesheet" />

		<!-- INTERNAL Data table css -->
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/datatable/css/dataTables.bootstrap4.min.css" rel="stylesheet" />

		<!-- INTERNAL Time picker css -->
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/time-picker/jquery.timepicker.css" rel="stylesheet" />

		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.min.css" rel="stylesheet" />

		<!-- INTERNAL jQuery-countdowntimer css -->
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/jQuery-countdowntimer/jQuery.countdownTimer.css" rel="stylesheet" />
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/accordion/accordion.css" rel="stylesheet" />
		
		
        <!-- INTERNAL WYSIWYG Editor css -->
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/wysiwyag/richtext.css" rel="stylesheet" />
        
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/quill/quill.snow.css" rel="stylesheet">
		<link href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/quill/quill.bubble.css" rel="stylesheet">
		...
		<script src="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/jquery.tokeninput.js"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/token-input.css">
		
		<!-- Orakuploader CSS-->
		<link type="text/css" href="<?php echo URL?><?php echo FOLDER_MEMBER?>orakuploader/orakuploader.css" rel="stylesheet"/>
	
		<!-- Jquery js-->
		<script src="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/jquery/jquery.min.js"></script>
        
        <script src="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/jquery/jquery.validate.js"></script>


		<link rel="stylesheet" href="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/multipleselect/multiple-select.css">

		<script src="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/multipleselect/multiple-select.js"></script>
		<script src="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/multipleselect/multi-select.js"></script>
		<link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.css" rel="stylesheet">
        <script src="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/summer-note/summernote1.js"></script>
		<script src="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/js/summernote.js"></script>

		<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.13.2/jquery-ui.min.js"></script>
		<!-- Orakuploader js-->
		<!--<script type="text/javascript" src="<?php echo URL?><?php echo FOLDER_MEMBER?>orakuploader/jquery-ui.min.js"></script>-->
		<script type="text/javascript" src="<?php echo URL?><?php echo FOLDER_MEMBER?>orakuploader/orakuploader.js"></script>
        
        <script src="<?php echo URL?><?php echo FOLDER_MEMBER?>templates/black/assets/plugins/modal-datepicker/datepicker.js"></script>
...
<body class="app sidebar-mini">
		...
		<div class="page">
         ...
         <?php require_once(PATH.FOLDER_MEMBER."templates/black/includes/sidebar.php"); ?>
		 <div class="app-content main-content">
			<div class="side-app">
				<?php require_once(PATH.FOLDER_MEMBER."templates/black/includes/header.php"); ?>
				...
				$component=$_GET['c'];
				 ...
				 $filename = PATH.FOLDER_MEMBER."components/".$component."/controller.php";
				
				if (file_exists($filename))
				require_once($filename);
				else
				require_once(PATH.FOLDER_MEMBER."components/error/view.php");
				 ?>
        
			</div>
        </div>
                
              <?php require_once(PATH.FOLDER_MEMBER."templates/black/includes/footer.php"); ?>  
