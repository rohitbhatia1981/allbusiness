...
<?php } ?>							
	...
	$sqlGroup = "SELECT * FROM tbl_groups where group_published=1";
...
<div class="row">
   ...
   <div class="card-body pb-2">
							...
							<div class="row ">
									...
									<select class="form-control" name="txtGroup" id="txtGroup"  <?php if($_GET['task'] == 'add'){ ?> onchange="if (this.value) window.location = 'index.php?c=users&task=add&Cid=1&Gid=' + this.options[this.selectedIndex].value" <?php } ?>>
		...
		$("#user-form").validate({
			...
			rules: {
				...
				txtUsername: {
						...
						url: "<?php echo URL.FOLDER_MEMBER; ?>components/<?php echo $component; ?>/checkusername.php",
				...
				txtEmail: {
                    ...
                    url: "<?php echo URL.FOLDER_MEMBER; ?>components/<?php echo $component; ?>/checkemail.php",
