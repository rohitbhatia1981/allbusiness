        ...
        if ($totalImages > 0) {
            ...
            if ($rowImages['image_s3'] == "") 
				...
				?>
                                    ...
                                    ID: <a href="" style="color:#06F; text-decoration:underline"><?php echo $row['business_id'] ?></a>
                                    <br /><br />
...
<div class="page-header d-lg-flex d-block">
	...
	<div class="page-rightheader ml-md-auto">
		<div class=" btn-list">
		<a href="" class="btn btn-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Back">
																<i class="fa fa-close"></i>
															</a>
		</div>
	</div>
...
<div class="row" style="padding-top:15px">
    ...
    <div class="ad-success-message">
        <h2>ðŸŽ‰ Your Ad has been successfully created!</h2>
