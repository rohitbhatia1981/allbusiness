...
<div class="modal fade" id="termsModal" tabindex="-1" role="dialog" aria-labelledby="termsModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <form id="confirmForm">
        ...
        <div style="margin:auto;border: 1px solid #e0e0e0; border-radius: 6px; padding: 20px; max-width: 600px; font-family: Arial, sans-serif; font-size: 14px; color: #1c1e21;">
  ...
  <div style="color: #6a6a6a; font-size: 13px; margin-bottom: 15px;">6x 1 month boosted ads</div>
