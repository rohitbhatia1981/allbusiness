...
<div class="page-header d-lg-flex d-block">
	...
	<div class="row flex-lg-nowrap">
        ...
        <div class="tabs-menu1">
                                        ...
                                        <li><a href="?c=<?php echo $_GET['c']?>"  <?php if ($_GET['ty']=="") { ?> class="active" <?php } ?> >Ad Credits Orders</a></li>
									...
									<table class="table table-bordered border-top text-nowrap" id="example1" width="100%">
										<thead>
											<tr>
                                                ...
                                                <th width="20%" class="border-bottom-0">Order Id</th>
                                                <th width="62%" class="border-bottom-0">Order Details</th>                                                                                            
