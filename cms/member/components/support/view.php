					...
					<div class="e-panel card">
						<div class="card-body">
                           ...
                           <div style="height:20px"></div>
							...
							<div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 col-xl-2">
												<div class="form-group">
                                                  ...
                                                  <select name="tkStatus" class="form-control">
                                                  	<option value="" <?php if ($_GET['tkStatus']=="") echo "selected"; ?>>Open</option>
                                                    <option value="1" <?php if ($_GET['tkStatus']==1) echo "selected"; ?>>Closed</option>
                                                  </select>
									...
									<table class="table table-bordered border-top text-nowrap" id="example1" width="100%">
										<thead>
											<tr>
												...
												<th width="8%" class="border-bottom-0">Ticket ID</th>
                                                <th width="47%" class="border-bottom-0">Subject</th>
                                                <th width="47%" class="border-bottom-0">Sent By</th>                                              
                                                <th width="27%" class="border-bottom-0">Last updated</th>
                                                <th width="18%" class="border-bottom-0 w-20">Action</th>
                                                <th width="18%" class="border-bottom-0 w-20">Status</th>
											</tr>
										</thead>
							...
							?>			
								<tr  class="trrow"  onclick="window.location='?c=<?php echo $component?>&task=detail&id=<?php echo $row['message_id']?>'">
                                    ...
                                    <td><?php echo getUserNameByType(strtolower($row['message_sender_type']),$row['message_sender_id']); ?> (<?php echo $row['message_sender_type']; ?>)</td>
                                    ...
                                    <td class="align-middle">
												...
												<?php echo displayDateTimeFormat($row['message_date']); ?>
										...
										<div class="d-flex">
											<div class="ml-3 mt-1">
												...
												?>
															...
															<span class="tag tag-red">To be Responded</span>
                                                            <?php } else { ?>
                                     ...
                                     <td class="align-middle">
										<div class="d-flex">
											<div class="ml-3 mt-1">
                                                			...
                                                			<?php if ($row['message_close']==0) { ?>
																<span class="tag tag-orange">Open</span>
                                                            <?php } else { ?>
                                                            <span class="tag tag-yellow">Closed</span>
                                                            <?php } ?>
							...
							<div class="col-xl-12 col-md-12 col-lg-12">
                             ...
                             <?php
								...
								<div class="panel-body tabs-menu-body hremp-tabs1 p-0">
                                            ...
                                            <?php if ($rowMessage['message_close']==1) { ?>
                                            <div class="pt-4 pb-4 text-end" align="left">
                                            	<h3 style="color:#F63">This ticket has been closed</h3>
                                            </div>
                                            <?php } else { ?>
                                            
												<div class="pt-4 pb-4 text-end" align="right">
                                                	
                                                	<a  href="javascript:void(0);" onclick="closeticket()" class="btn btn-secondary">Close Ticket</a>
                                                    &nbsp;&nbsp;&nbsp;
...
{
	ans=confirm("Are you sure you want to close this ticket");
	
	if (ans==true)
	window.location="?c=support&task=close&id=<?php echo $_GET['id']?>";
}
