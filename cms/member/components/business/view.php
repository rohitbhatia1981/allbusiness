												...
												<div class="col-7">
													<div class="mt-0 text-left">
														...
														<h3 class="mb-0 mt-1 text-success fs-25">
                                                         ...
                                                         <?php
													$statsSql = "SELECT * FROM tbl_business where business_status='current' and business_active_status=1  and business_owner_id='".$database->filter($_SESSION['sess_member_id'])."'";
													$stats = $database->get_results( $statsSql );
													echo $statsCount = count($stats);
											...
											<div class="row" style="padding-top:15px">
												<div class="col-7">
													<div class="mt-0 text-left">
                                                        ...
                                                        <?php
													$statsSql = "SELECT * FROM tbl_business where business_status='sold' and business_owner_id='".$database->filter($_SESSION['sess_member_id'])."'";
													$stats = $database->get_results( $statsSql );
													echo $statsCount = count($stats);
												...
												<div class="col-7">
													<div class="mt-0 text-left">
														...
														<h3 class="mb-0 mt-1 text-danger fs-25">
                                                         ...
                                                         <?php
													$statsSql = "SELECT * FROM tbl_business where business_status<>'current' and business_owner_id='".$database->filter($_SESSION['sess_member_id'])."'";
													$stats = $database->get_results( $statsSql );
													echo $statsCount = count($stats);
							...
							<tbody>
								<tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <?php } else { ?>
                                        <a href="?c=business&task=subscribe&id=<?php echo $row['business_id']?>"><button type="button" class="btn btn-pill btn-secondary">Subsribe to Make Live</button></a>
                                        <?php } ?>
