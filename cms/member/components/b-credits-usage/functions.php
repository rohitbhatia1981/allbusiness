<?php
	...
	global $database, $page, $pagingObject;
		...
		$sql = "SELECT * from tbl_ad_usage where usage_agency_id='".$database->filter($_SESSION['sess_member_id'])."' ";

		
		if($_GET['txtSearchByTitle'] != "")

		{
			$sql.=" and (usage_id ='".$_GET['txtSearchByTitle']."' || usage_ad_id ='".$_GET['txtSearchByTitle']."')";
		...
		{
			$sql.=" and usage_date <='".$_GET['txtEDate']."'";

		}
		

		$sql .= " order by usage_id desc";
