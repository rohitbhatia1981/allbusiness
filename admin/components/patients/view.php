							...
							<div class="page-rightheader ml-md-auto">
								<div class="d-flex align-items-end flex-wrap my-auto right-content breadcrumb-right">
									<div class="btn-list">
										...
										<a href="?c=<?php echo $component?>&task=edit&Cid=<?php echo $menuid['component_headingid']; ?>&id=<?php echo $row['page_id']; ?>" class="btn btn-light" data-toggle="tooltip" data-placement="top" title="Edit Patient"> <i class="feather feather-edit"></i> </a>
