                                                 ...
                                                 <div class="col-md-12 col-lg-12 col-xl-3">
														<div class="form-group">
															...
															<div class="input-group">
																...
																</div><input class="form-control" name="txtPatient" type="text" value="<?php echo $_GET['txtPatient']?>">
															</div>
														</div>
													</div>
									...
									<table class="table table-bordered border-top text-nowrap" id="example1" width="100%">
										<thead>
											<tr>
                                                ...
                                                <th width="13%" class="border-bottom-0">Invoice Id</th>
