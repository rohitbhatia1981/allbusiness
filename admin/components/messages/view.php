	...
	<div class="row flex-lg-nowrap">
							...
							<div class="row">
											...
											<div class="col-md-12 col-lg-12 col-xl-3">
												<div class="form-group">
													...
													<input class="form-control fc-datepicker" name="txtSDate" placeholder="" type="date">
												</div>
											</div>
		...
		<input type="checkbox" class="custom-control-input" name="chkControl" value="yes" onClick="checkAll(this.form,this.checked);" />
							...
							?>				
								...
								<tr style="font-weight:<?php echo $readStatus; ?>;">
									
									<td class="align-middle">
										<label class="custom-control custom-checkbox">
				
				<input name="deletes[]" id="chkDelete" onClick="isChecked(this.checked);" class="custom-control-input" value="<?php echo $row['message_id']; ?>" type="checkbox"  />			
											<span class="custom-control-label"></span>
										</label>
									</td>
                                    <td class="align-middle" >
									...
									<div class="card-body pb-0 pt-3">
										<div>
											...
											<p class="" style="font-weight:<?php echo $readStatus?>">Business id: <a href="?c=business&task=edit&id=<?php echo $row['business_id']?>" style="color:#09C">AB-<?php echo $row['business_id']; ?></a>, dt: <?php echo displayDateFormat($row['inquiry_date']); ?></p>
										</div>
									</div>	
                                    ...
                                    <td class="align-middle">
												...
												<?php echo fn_formatDateTime($row['inquiry_date']); ?>
